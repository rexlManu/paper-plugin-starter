...
public interface TaskScheduler {
  ...
  /**
   * <b>Folia & Paper</b>: Returns whether the current thread is ticking a region and that the
   * region being ticked owns the specified entity. Note that this function is the only appropriate
   * method of checking for ownership of an entity, as retrieving the entity's location is undefined
   * unless the entity is owned by the current region
   *
   * <p><b>Bukkit</b>: returns {@link org.bukkit.Server#isPrimaryThread}
   *
  ...
  /**
   * <b>Folia & Paper</b>: Returns whether the current thread is ticking a region and that the
   * region being ticked owns the chunk at the specified world and block position as included in the
   * specified location
   *
   * <p><b>Bukkit</b>: returns {@link org.bukkit.Server#isPrimaryThread}
   *
   ...
   */
  BaseScheduledTask runTask(Runnable runnable);
   ...
   */
  BaseScheduledTask runTaskLater(Runnable runnable, long delay);
   ...
   */
  BaseScheduledTask runTaskTimer(Runnable runnable, long delay, long period);

  /** Deprecated: use {@link #runTask(Runnable)} */
  @Deprecated
  default BaseScheduledTask runTask(Plugin plugin, Runnable runnable) {
    return runTask(runnable);
  }

  /** Deprecated: use {@link #runTaskLater(Runnable, long)} */
  @Deprecated
  default BaseScheduledTask runTaskLater(Plugin plugin, Runnable runnable, long delay) {
  ...
  /**
   * <b>Folia & Paper</b>: Schedules a task to be executed on the region which owns the location on
   * the next tick
   *
   * <p><b>Bukkit</b>: same as {@link #runTask(Runnable)}
   *
   * @param location The location which the region executing should own
   * @param runnable The task to execute
   */
  default BaseScheduledTask runTask(Location location, Runnable runnable) {
    return runTask(runnable);
  }

  /**
   * <b>Folia & Paper</b>: Schedules a task to be executed on the region which owns the location
   * after the specified delay in ticks
   *
   * <p><b>Bukkit</b>: same as {@link #runTaskLater(Runnable, long)}
   *
   * @param location The location which the region executing should own
   * @param runnable The task to execute
   * @param delay The delay, in ticks.
   */
  default BaseScheduledTask runTaskLater(Location location, Runnable runnable, long delay) {
    return runTaskLater(runnable, delay);
  }

  /**
   * <b>Folia & Paper</b>: Schedules a repeating task to be executed on the region which owns the
   * location after the initial delay with the specified period
   *
   * <p><b>Bukkit</b>: same as {@link #runTaskTimer(Runnable, long, long)}
   *
   * @param location The location which the region executing should own
   * @param runnable The task to execute
   * @param delay The initial delay, in ticks.
  ...
  /** Deprecated: use {@link #runTaskLater(Runnable, long)} */
  @Deprecated
  default BaseScheduledTask scheduleSyncDelayedTask(Runnable runnable, long delay) {
    return runTaskLater(runnable, delay);
  }

  /** Deprecated: use {@link #execute(Runnable)} or {@link #runTask(Runnable)} */
  @Deprecated
  default BaseScheduledTask scheduleSyncDelayedTask(Runnable runnable) {
    return runTask(runnable);
  }

  /** Deprecated: use {@link #runTaskTimer(Runnable, long, long)} */
  @Deprecated
  default BaseScheduledTask scheduleSyncRepeatingTask(Runnable runnable, long delay, long period) {
    return runTaskTimer(runnable, delay, period);
  }

  /**
   * <b>Folia & Paper</b>: Schedules a task to be executed on the region which owns the location of
   * given entity on the next tick
   *
   * <p><b>Bukkit</b>: same as {@link #runTask(Runnable)}
   *
   ...
   * @param runnable The task to execute
   */
  default BaseScheduledTask runTask(Entity entity, Runnable runnable) {
    return runTask(runnable);
  }

  /**
   * <b>Folia & Paper</b>: Schedules a task to be executed on the region which owns the location of
   * given entity after the specified delay in ticks
   *
   * <p><b>Bukkit</b>: same as {@link #runTaskLater(Runnable, long)}
   *
   * @param entity The entity whose location the region executing should own
   ...
   * @param delay The delay, in ticks.
   */
  default BaseScheduledTask runTaskLater(Entity entity, Runnable runnable, long delay) {
    return runTaskLater(runnable, delay);
  }
   ...
   *
   * @param runnable The task to execute
   * @return The {@link BaseScheduledTask} that represents the scheduled task
   */
  BaseScheduledTask runTaskAsynchronously(Runnable runnable);
   ...
   * @return The {@link BaseScheduledTask} that represents the scheduled task
   */
  BaseScheduledTask runTaskLaterAsynchronously(Runnable runnable, long delay);
   ...
   * @return The {@link BaseScheduledTask} that represents the scheduled task
   */
  BaseScheduledTask runTaskTimerAsynchronously(Runnable runnable, long delay, long period);

  /** Deprecated: use {@link #runTaskAsynchronously(Runnable)} */
  @Deprecated
  default BaseScheduledTask runTaskAsynchronously(Plugin plugin, Runnable runnable) {
  ...
  @Deprecated
  default BaseScheduledTask runTaskTimerAsynchronously(
      Plugin plugin, Runnable runnable, long delay, long period) {
   ...
   * the main(Bukkit)/global(Folia&Paper) server thread.
   *
   * <p>Note: The Future.get() methods must NOT be called from the main thread.
   *
   * <p>Note2: There is at least an average of 10ms latency until the isDone() method returns true.
   *
